...
- (void)applicationDidFinishLaunching:(CPNotification)aNotification
{
    ...
    // Projects Controller
    var projectsController  = [[ProjectsController alloc] init:tasksController] ;

    var toolbar = [[CPToolbar alloc] initWithIdentifier:"Tasks"] ;
    ...
    // Root split view
    var rootSplitView = [[CPSplitView alloc] initWithFrame:CGRectMake(0.0, 0.0, CGRectGetWidth([contentView bounds]), CGRectGetHeight([contentView bounds]))];
    // Horizontal
    ...
    var taskListScrollView = [[CPScrollView alloc] initWithFrame:CGRectMake(200.0, 0.0, CGRectGetWidth([contentView bounds])-200.0, CGRectGetHeight([contentView bounds]))] ;
    ...
    var timeLogListScrollView = [[CPScrollView alloc] initWithFrame:CGRectMake(0.0, 200.0, CGRectGetWidth([contentView bounds]), CGRectGetHeight([contentView bounds])-200.0)] ;
